...
Since `joypixels` relies on system fonts and color emoji support, it **will work with pdfLaTeX**. It's helpful to explicitly state:
> **Note:** This project must be compiled with **XeLaTeX** or **LuaLaTeX**. Standard pdfLaTeX is supported.
...
\begin{document}
Hello World! 😀 % Prints a grinning face
\end{document}
```
